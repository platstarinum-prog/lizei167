...
export default function About() {
  ...
  return (
    ...
    Німецький мовний диплом (DSD) – це диплом Конференції міністрів освіти ФРН, який мають можливість отримувати учні з 1972 року. Підставою для отримання диплому  є навчання в  одній із акредитованих DSD- шкіл і складання  мовного іспиту.
         За час участі нашого закладу освіти у програми з 2008 року дипломи рівня В2, С1 отримали 218 випускників.
      Німецькомовний диплом свідчить про високий рівень знань з німецької мови і є передумовою навчання в університетах Німеччини, відкриває широкі горизонти випускникам навчального закладу у виборі майбутньої професії, підвищує їх конкурентноздатність.  Німецький мовний диплом, отриманий в Україні, підтверджує, що його власник має знання, що відповідають європейській системі оцінювання знань з мови і йому не потрібно складати  більше ніяких мовних іспитів, щоб навчатися у ВНЗ Німеччини. У рамках ДСД-програми за підтримки Посольства ФРН в Україні та служби німецького академічного обміну Німеччини серед випускників ДСД-шкіл України щорічно відбувається конкурс, переможці якого отримують стипендію на навчання в університетах Німеччини.
    Чимало  випускників  Ліцею № 167, які отримали Німецький мовний диплом,  навчаються в найкращих університетах  Німеччини: у Дармштадті, Франкфурті,  Марбурзі. Бохумі,  Міттельхессені, Берліні, Халлє та Кетені.
